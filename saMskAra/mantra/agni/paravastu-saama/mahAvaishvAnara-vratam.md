...
इ*([रः])*हा*(“)*स्व,, वैश्वा*([“])*नरा*([“]%)*य, प्रादी*(%)*शॊ,ऒ ज्यो*(%)*तिर्[*([58])*](#ftnt58), बृहा*(%)*त*(v)*।
...
द्यौ*([“पो])*र्भू*([“])*उतम्*(३)* {पृ*([र])*थि[*([60])*](#ftnt60)वी*(३”)*}*([त्रिः])*। {पृ*([र])*थिव्यो*([“]%)*वा*([“]३)*}*([ त्रिः])*
...
य*([प])*न्मातॄ[*([61])*](#ftnt61)*([“]३)*र् अजगन्न् अपा*(३)*ह। {अपा*([प]३)*ह।}*([द्विः])*। {आ*([र]%)*पो*([“]%)*वा*([“]३)*}*([त्रिः])*।
...
न*([प])*त[*([62])*](#ftnt62)त्ते*([“])*, अग्ने*([“])*, प्रमृषे*([“]३)*, निवर्तना*(o३)*म् । {त*([प])*ना*(o३)*म्}*([द्विः])*। {ता*([र]%)*नो*([“]%)*वा*([“]३)*}*([त्रिः])*।

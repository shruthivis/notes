...
{हा*([प])*उ}*([त्रिः]द्रु)**(~~#ftnt19~~)* {औ*([धा]“३)*उहु,हो*(“३)*इ}*([त्रिः])*।

सो*(["]%)*मा*(“"”३)*म्। इन्*([ता])*द्रा*(३”)* +मा,,{द*([ता])*तुत्वा*(“)*अ।}*([त्रिः])*।*(~~#ftnt20~~)*
...
यन्*([र])*ते*(["ऽ])* सुषा*(“३)*,वा*([पो])* हार्या*(३)*{श्वा*(["ता])*द्री*(३")**(~~#ftnt21~~)*इहि।}*([द्विः])*। श्वा*(["])**([त])*द्रिः ।
...
सो*(["])**([प])*तुर् बा*(["]%)*हू*(“३)*भ्या,अम्*([पो])*सुया,तो, {ना*([ता]%)*र्वा*([??]३“)**(~~#ftnt22~~)*अ}*([द्वि:])*। ना*([त])*र्वा।
